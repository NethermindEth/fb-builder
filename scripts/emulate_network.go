...
- build
  ...
  - -f           : Build dockerfile path (optional, default: ../Dockerfile"), use "./Dockerfile.debug" for debug capabileties)
- run
  - -t           : Image tag (optional, default: "flashbots/builder:dev")
...
func main() {
	...
	case "build":
		...
		buildDockerfilePath := flagSet.String("f", "../Dockerfile", "Build dockerfile path. Use \"./Dockerfile.debug\" for debug capabileties")
